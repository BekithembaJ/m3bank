...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>Information of account holder</h1>
			<address >
				<p>M3 Bank,</p>
				<p>1112 Mbatha Drive,<br>White City,<br>Soweto.</p>
				<p>(+27) 814 01 2910 </p>
			</address>
			<span><img alt="" src="assets/img/son.png" width="110" length="400"></span>
		</header>
		<article>
			<h1></h1>
			<address >
			...
			<table class="inventory">
				<thead>
					<tr>
						<th><span >Accont History</span></th>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@m3bank.com || Web :- www.m3bank.com || Phone :- +27 814 01 2910 </p>
			</div>
		</aside>
	</body>
</html>
