...
<h3>Congrats, you can logIn now</h3>
 ...
 <div class="container">
      ...
      <div id="login">
        ...
        <form method="post">
          ...
          <fieldset class="clearfix">
            ...
            <p><span class="fa fas-lock"></span><input type="password" name="pass"  value="Password" onBlur="if(this.value == '') this.value = 'Password'" onFocus="if(this.value == 'Password') this.value = ''" required></p> <!-- JS because of IE support; better: placeholder="Password" -->
    ...
    <div class="bottom">  <h3><a href="../index.html">M3 BANK HOMEPAGE</a></h3></div>
